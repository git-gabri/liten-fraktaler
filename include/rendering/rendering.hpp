...
std::complex<long double> (*init_fractal_fn_pointer(const fractalsettings_t& fsettings))(const std::complex<long double>& last_z, const std::complex<long double>& c, const std::vector<std::complex<long double>>& history, const std::vector<std::complex<long double>>& extra_params, const fractalsettings_t& fsettings);
